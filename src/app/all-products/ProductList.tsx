...
const ProductList = () => {
  ...
  return (
    <div className="font-montserrat mx-auto w-[100%] max-w-[1480px] my-4 lg:px-8 md:px-6 px-4">
            ...
            >
              ...
              >
                <span className={`text-yellow-500`}>
                  {"★".repeat(Math.floor(4.3))}
                  {"☆".repeat(5 - Math.floor(4.3))}
                </span>
                <span className="ml-2 lg:text-[12px] text-[10px] text-custom-gray">({4.3})</span>
              </div>
