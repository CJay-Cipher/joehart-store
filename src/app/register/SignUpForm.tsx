        ...
        <form action="" className="flex flex-col items-center">
          <div className="w-full flex flex-col items-center xl:gap-4 md:gap-3 gap-2">
            <div className="xl:max-w-[380px] md:max-w-[340px] max-w-[320px] w-full">
              ...
              <input
                type="text"
                className="w-full xl:h-[45px] md:h-[40px] 2xs:h-[38px] h-[37px] xs:p-4 p-3 lg:text-[16px] md:text-[14px] text-[12px] xl:rounded-[15px] md:rounded-[10px] rounded-[20px] border border-custom-gray-dark"
          ...
          <button className="xl:max-w-[380px] md:max-w-[340px] max-w-[320px] w-full xl:h-[45px] md:h-[40px] 2xs:h-[38px] h-[37px] md:mt-8 mt-6 lg:text-[18px] md:text-[16px] text-[14px] text-main-white font-medium bg-custom-blue-2 hover:bg-custom-blue xl:rounded-[15px] md:rounded-[10px] rounded-[20px] border border-custom-gray-dark">
            Create Account
          </button>
