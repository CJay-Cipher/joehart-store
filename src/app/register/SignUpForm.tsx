...
const SignUpForm = () => {
  ...
  return (
    <div className="md:flex-1 flex justify-center items-center min-h-max w-full z-10 md:pt-6 p-4">
      <div className="bg-main-white w-full xl:max-w-[400px] md:max-w-[380px] xs:max-w-[350px] xl:py-8 lg:py-6 p-4 border border-shadow lg:rounded-[20px] rounded-[15px] shadow-xl">
        ...
        <form action="" className="flex flex-col items-center">
          <div className="w-full flex flex-col items-center md:gap-3 gap-2">
            <div className="xl:max-w-[380px] md:max-w-[340px] xs:max-w-[320px] w-full">
          ...
          <button className="xl:max-w-[380px] md:max-w-[340px] xs:max-w-[320px] w-full xl:h-[45px] md:h-[40px] 2xs:h-[38px] h-[37px] md:mt-10 mt-8 lg:text-[18px] md:text-[16px] text-[14px] text-main-white font-semibold bg-custom-blue-2 hover:bg-custom-blue rounded-[15px] border border-custom-gray-dark shadow-md">
            Create Account
          </button>
