...
//       <div className="segoeUI relative z-20 bg-white gap-3 items-center flex text-center justify-center p-4">
//         <CallToAction
//           path={urlRegister}
//           text=" Get started for free"
//           className={
//             "w-[172px] font-medium bg-[#044E97] text-[#fff] text-[14px]"
//           }
//         />
//         <CallToAction
//           path={url}
//           text="Login"
//           className={
//             "w-[148px] font-semibold border border-[#044E97] text-[#044E97] text-[16px] "
//           }
//         />
//       </div>
