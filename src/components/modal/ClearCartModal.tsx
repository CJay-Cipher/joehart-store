    ...
    <div className="fixed z-100 inset-0 bg-modal-bg flex justify-center items-center p-4 ">
      <div className="relative flex flex-col items-center p-6 w-full lg:max-w-[450px] max-w-[370px] bg-main-white md:rounded-[20px] rounded-[10px] ">
        ...
        <h2 className="text-center text-button-bg font-bold lg:text-[18px] text-[16px]">
          Are you sure you want <br /> to clear cart?
        </h2>
        <p className="mt-1 text-center text-main-black lg:text-[14px] text-[12px]">This action can't be reversed and your cart will become empty!</p>
