      ...
      <div className="flex flex-wrap justify-center md:gap-4 gap-3 lg:mt-8 mt-4">
        {products.map((product) => (
          ...
          >
              ...
              <div className="">
                ...
                <div className="flex flex-row-reverse 3xs:max-xs:flex-col gap-2 mt-2">
                  <div className="flex justify-between gap-2">
                    <button className="flex items-center md:gap-2 gap-1 lg:text-[14px] text-[12px] text-button-bg border border-button-bg py-1 px-2 rounded hover:border-transparent hover:text-main-white hover:bg-button-bg-hover ">
            ...
            <button className="absolute 3xs:max-xs:left-2 top-2 right-2 flex items-center justify-center md:gap-2 gap-1 lg:text-[14px] text-[12px] text-custom-slate-400 bg-main-white border border-custom-slate-400 xl:h-8 xl:w-8 h-7 w-7 rounded-[50%] hover:text-custom-red hover:border-custom-red">
